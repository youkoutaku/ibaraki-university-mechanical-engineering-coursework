...
//            □ 連続キー入力による合成変換
//              
// (Windows マクロ無し）gcc -o keybord keybord.c -lfreeglut -lglu32 -lopengl32
// (Windows マクロ使用)	gccgl -o keybord keybord.c
// (Mac OS の場合)			gcc -o keybord keybord.c -framework OpenGL -framework GLUT -DGL_SILENCE_DEPRECATION
//--------------------------------------------------------------------------- 
