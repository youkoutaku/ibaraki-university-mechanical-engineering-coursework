...
//													N角形の描画（POLYGON)(タブ2）
//
// (Windows マクロ無し）gcc -o polygon_aft polygon_aft.c -lfreeglut -lglu32 -lopengl32
// (Windows マクロ使用)	gccgl -o polygon_aft polygon_aft.c
// (Mac OS の場合)			gcc -o polygon_aft polygon_aft.c -framework OpenGL -framework GLUT -DGL_SILENCE_DEPRECATION
//--------------------------------------------------------------------------- 
