...
//struct prog2型の宣言（関数のプロトタイプ宣言の前に行う）
struct prog2{
	int 	ID;			//学生番号
	char    name[20];	//名前
	int		final;		//期末試験得点
...
int main(void)
{
	...
	struct prog2 Mech[SNUM]={0};			//学生データ用配列
...
/*----------------------------------------------------------------------*/
/*      関数名：load_data                                               */
/*		仮引数：char型へのポインタfname, struct prog2型へのポインタobj　*/
/*		戻り値:なし　　　　　　　　　　　　　　　　　　　　 　　　　　　*/
