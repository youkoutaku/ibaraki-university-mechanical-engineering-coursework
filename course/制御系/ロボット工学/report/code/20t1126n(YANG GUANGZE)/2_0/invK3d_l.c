...
{	
	pos[X] = ( len[L2]*cos(tht[J2]) + len[L3]*cos(tht[J2]+tht[J3]) + (len[L4]+len[L5])*cos(tht[J2]+tht[J3]+tht[J4]) )*cos(tht[J1]);
	pos[Y] = ( len[L2]*cos(tht[J2]) + len[L3]*cos(tht[J2]+tht[J3]) + (len[L4]+len[L5])*cos(tht[J2]+tht[J3]+tht[J4]) )*sin(tht[J1]);
	pos[Z] = len[L1] + len[L2]*sin(tht[J2]) + len[L3]*sin(tht[J2]+tht[J3]) + (len[L4]+len[L5])*sin(tht[J2]+tht[J3]+tht[J4]);
}
...
void jacobianMatrix( len, tht, Jaco )
	...
	MAT *Jaco;
{
	MATelem(*Jaco,1,1)= -( len[L2]*cos(tht[J2]) + len[L3]*cos(tht[J2]+tht[J3]) + (len[L4]+len[L5])*cos(tht[J2]+tht[J3]+tht[J4]) ) * sin(tht[J1]);
	MATelem(*Jaco,1,2)= -( len[L2]*sin(tht[J2]) + len[L3]*sin(tht[J2]+tht[J3]) + (len[L4]+len[L5])*sin(tht[J2]+tht[J3]+tht[J4]) ) * cos(tht[J1]);
	MATelem(*Jaco,1,3)= -( len[L3]*sin(tht[J2]+tht[J3]) + (len[L4]+len[L5])*sin(tht[J2]+tht[J3]+tht[J4]) ) * cos(tht[J1]);
	MATelem(*Jaco,1,4)= -(len[L4]+len[L5])*sin(tht[J2]+tht[J3]+tht[J4]) * cos(tht[J1] );


	MATelem(*Jaco,2,1)=  ( len[L2]*cos(tht[J2]) + len[L3]*cos(tht[J2]+tht[J3]) + (len[L4]+len[L5])*cos(tht[J2]+tht[J3]+tht[J4]) ) * cos(tht[J1]);
	MATelem(*Jaco,2,2)= -( len[L2]*sin(tht[J2]) + len[L3]*sin(tht[J2]+tht[J3]) + (len[L4]+len[L5])*sin(tht[J2]+tht[J3]+tht[J4]) ) * sin(tht[J1]);
	MATelem(*Jaco,2,3)= -( len[L3]*sin(tht[J2]+tht[J3]) + (len[L4]+len[L5])*sin(tht[J2]+tht[J3]+tht[J4]) ) * sin(tht[J1]);
	MATelem(*Jaco,2,4)= -(len[L4]+len[L5])*sin(tht[J2]+tht[J3]+tht[J4]) * sin(tht[J1]);


	MATelem(*Jaco,3,1)= 0;
	MATelem(*Jaco,3,2)= len[L2]*cos(tht[J2]) + len[L3]*cos(tht[J2]+tht[J3]) + (len[L4]+len[L5])*cos(tht[J2]+tht[J3]+tht[J4]);
	MATelem(*Jaco,3,3)= len[L3]*cos(tht[J2]+tht[J3]) + (len[L4]+len[L5])*cos(tht[J2]+tht[J3]+tht[J4]);
	MATelem(*Jaco,3,4)= (len[L4]+len[L5])*cos(tht[J2]+tht[J3]+tht[J4]);
